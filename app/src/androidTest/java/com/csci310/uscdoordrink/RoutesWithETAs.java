...
public class RoutesWithETAs {
    ...
    public void routesWithETAs() {
        ...
        try {
            ...
            Symbol symbol = mapTestAPI.findSymbolFromMerchantName("Omar Drinks");
            if (a == null) {
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.mapPageETAText),
                        withParent(withParent(withId(R.id.rlContainer))),
                        isDisplayed()));
        button.check(matches(isDisplayed()));

        try {
            MapTestAPI mapTestAPI = new MapTestAPI();
            Symbol symbol = mapTestAPI.findSymbolFromMerchantName("SCP-294");
            if (a == null) {
                CredentialTestingManager.logOut();
            }
            mapTestAPI.clickOnSymbol(symbol, a, mUiDevice);
